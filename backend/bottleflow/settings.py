"""
Django settings for bottleflow project.
"""
...
WSGI_APPLICATION = 'bottleflow.wsgi.application'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@bottleflow.com')
